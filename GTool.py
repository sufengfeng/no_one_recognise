    ...
    def editConfigFile(self):
        ...
        try:
            ...
            with open(config_path, "r") as f:
                ...
                s = s.replace("\"SUBDUT1\":{\"sn\":\"" + _subdut_sn + "\"",
                              "\"SUBDUT1\":{\"sn\":\"" + self.subdut_sn() + "\"")
...
class SetItemList(QListWidget):
    def __init__(self, types, parent=None):
        ...
        self.setSelectionMode(
            QAbstractItemView.ExtendedSelection)  # 说选择模式有:ExtendedSelection 按住ctrl多选,SingleSelection 单选 MultiSelection 点击多选 ContiguousSelection鼠标拖拉多选
